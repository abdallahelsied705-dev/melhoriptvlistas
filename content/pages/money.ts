...
export const moneyPages: Page[] = [
  {
    ...
    summary: `Um plano de IPTV custa ${formatEuro(lowestPrice)} por 1 mês e ${formatEuro(priceFor(1, 12))} por 12 meses (cerca de ${formatEuro(lowestMonthly)} por mês) para 1 dispositivo. Todos os planos incluem ${facts.channels}, ${facts.vod}, guia TV e apoio ${offer.support}, sem fidelização. Cada dispositivo extra em simultâneo aumenta o preço, como mostra a tabela.`,
    updated,
    blocks: [
      { t: "pricing" },
      ...
      {
        t: "p",
        text: `O preço muda com a **duração** e com o **número de ecrãs a ver ao mesmo tempo** — o conteúdo é igual em todos os planos. Não há planos "básicos" com menos canais.`,
      },
      { t: "facts" },
      ...
      { t: "h2", text: "Que plano faz mais sentido para ti?" },
      {
        ...
        items: [
          ...
          `**12 meses** — o custo mensal mais baixo: cerca de ${formatEuro(lowestMonthly)} por mês com 1 dispositivo.`,
        ],
      },
      {
        t: "callout",
      ...
      { t: "h2", text: "Como funciona o pagamento" },
      {
        t: "steps",
        items: [
          { title: "Escolhe o plano", text: "Na tabela acima, seleciona o número de dispositivos e carrega em «Escolher plano». O WhatsApp abre com o plano e o preço já escritos." },
