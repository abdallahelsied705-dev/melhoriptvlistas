 ...
 * Preços por duração e dispositivo iguais à tabela do iptvbr.pt (setembro 2026).
 */
...
export const offer = {
  ...
  /** Preço total em euros por dispositivos em simultâneo e duração. */
  prices: {
...
/** Custo mensal mais baixo (1 dispositivo, plano anual). */
